...
Matrix<T> Matrix<T>::operator+(const Matrix<T> &rhs)
{
    ...
    results.set_A(get_A() + rhs.get_A());
    results.set_B(get_B() + rhs.get_B());
    results.set_C(get_C() + rhs.get_C());
    results.set_D(get_D() + rhs.get_D());
...
Matrix<T> Matrix<T>::operator-(const Matrix<T> &rhs)
{
    ...
    results.set_A(this->get_A() - rhs.get_A());
    results.set_B(this->get_B() - rhs.get_B());
    results.set_C(this->get_C() - rhs.get_C());
    results.set_D(this->get_D() - rhs.get_D());
...
Matrix<T> Matrix<T>::operator-=(const Matrix<T> &rhs)
{
    ...
    this->set_A(get_A() - rhs.get_A());
    this->set_B(get_B() - rhs.get_B());
    this->set_C(get_C() - rhs.get_C());
    this->set_D(get_D() - rhs.get_D());
